...
$sorted | ConvertTo-Json -Depth 4 | Set-Content -Encoding ascii '.\mt5-portable\reports\csv10y_liquidity_final_probe.json'
$sorted | Format-Table -AutoSize | Out-String | Set-Content -Encoding ascii '.\mt5-portable\reports\csv10y_liquidity_final_probe.txt'
Get-Content '.\mt5-portable\reports\csv10y_liquidity_final_probe.txt'
