...
$cases = @(
    @{ Name = 'live247_final_01_spread180_tp128'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpLqTpR=1.28','InpTrailStartAtr=1.20','InpTrailAtrMult=1.00') },
    @{ Name = 'live247_final_02_spread180_tp128_ts130'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpLqTpR=1.28','InpTrailStartAtr=1.30','InpTrailAtrMult=1.00') },
    @{ Name = 'live247_final_03_spread180_tp130_ts130'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpLqTpR=1.30','InpTrailStartAtr=1.30','InpTrailAtrMult=1.00') },
    @{ Name = 'live247_final_04_spread180_ts130'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpTrailStartAtr=1.30','InpTrailAtrMult=1.00') },
    @{ Name = 'live247_final_05_tp128_ts130'; Override = @('InpLqTpR=1.28','InpTrailStartAtr=1.30','InpTrailAtrMult=1.00') },
    @{ Name = 'live247_final_06_spread180_tp128_session522'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpLqTpR=1.28','InpTrailStartAtr=1.20','InpTrailAtrMult=1.00','InpTradeEndHour=22') },
    @{ Name = 'live247_final_07_spread180_tp128_struct035'; Override = @('InpSpreadMedianMult=1.80','InpShieldMaxSpreadPoints=24','InpShieldSpreadSpikeMult=1.60','InpLqTpR=1.28','InpTrailStartAtr=1.20','InpTrailAtrMult=1.00','InpLqStructuralTrailAtr=0.35') }
)
...
$jsonPath = Join-Path $PSScriptRoot '..\..\mt5-portable\reports\live247_final_refine.json'
$txtPath = Join-Path $PSScriptRoot '..\..\mt5-portable\reports\live247_final_refine.txt'
